...
if(isset($_POST['Confirmer'])) {
    ...
    $prenomelev = $_SESSION['USER_ID'];
    $eleve = $_SESSION['PRENOM'].' '.$_SESSION['NOM'];
    $prof = $_POST['prenom_prof'].' '.$_POST['nom_prof'];
...
// On vérifie si les champs sont vides
    if ($prix == 'a') {
        ...
        $sql = $bdd->prepare("INSERT INTO cours_dispense(CD_ID,USER_ID_PROF, ELEVE_NAME, MATIERE_PRIX,NBR_HEURE,START_DATE,PRIX,STATUS_ID,PROF,ELEVE) VALUES('',:id,:nom,:matiere,:nbr,:dates,:prix,'1',:prof,:eleve)");
