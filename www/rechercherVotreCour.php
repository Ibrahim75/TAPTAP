   ...
   if (isset($_GET['msg1_connexion']))
    ...
    <ion-list id="choixDuCours-list14">
      <ion-item class="item-icon-left dark" id="choixDuCours-list-item18">
        <form method="POST" action="../www/#/rechercherCours"class="list">
          <input id="connexion-button3" class="button button-balanced  button-block" type="submit" name="vali" value="Retour">
          <br>
      </form>
      ...
      if(empty($nom))
      {
        echo '<font color="red">probleme</font>'.$nom;
      }
